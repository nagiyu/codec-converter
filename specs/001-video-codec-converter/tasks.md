...
- [x] T005 [P] Next.js の最低限の雛形を確認/追加: web/nextjs/package.json
...
- [x] T012 IAM 最小権限ロールのテンプレートを追加: infra/iam/lambda-batch-roles.yaml
- [x] T013 CI で Docker イメージをビルドして ECR にプッシュするステップをワークフローに追加: .github/workflows/deploy.yml
